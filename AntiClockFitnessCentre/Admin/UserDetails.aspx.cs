...
namespace AntiClockFitnessCentre.Admin
{
    public partial class UserDetails : System.Web.UI.Page
    {
        ...
        {
            DataTable _RoledeialsTBL = _userBL.GetRole(roleId);
        ...
        private void LoadUserdetails(int i)
        {
            ...
            DataTable _userdeialsTBL = _userBL.GetUserDetails(i,roleId,companyID);

            imgProfilepic.ImageUrl = "ProfileImage.ashx?ID=" + i + "";
            ...
            if (_userdeialsTBL.Rows.Count > 0)
            {
                ...
                txtMemberNumber.Enabled = _userdeialsTBL.Rows[0]["RoleID"].ToString() == "2" ? true : false;
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _userdetails.trainerid = string.IsNullOrEmpty(ddlTrainer.SelectedValue.Trim()) ? 0 : Convert.ToInt32(ddlTrainer.SelectedValue);
                ...
                _userdetails.companyid = companyID;
        ...
        protected void ddlRole_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddlRole.SelectedIndex > 0)
            {
                ...
                txtMemberNumber.Enabled = Convert.ToInt32(ddlRole.SelectedValue.ToString()) == 2 ? true : false;
