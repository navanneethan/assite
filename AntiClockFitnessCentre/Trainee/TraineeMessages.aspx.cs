...
{
    public partial class TraineeMessages : System.Web.UI.Page
    {
        ...
        private StringBuilder GetImages(string storevalues)
        {
            ...
            for (int i = 0; i < imglist.Count(); i++)
            {
                ...
                if (i == 0)
                {
                    ...
                    _strBuild.Append("  <img src='../Uploads/" + imglist[i].ToString() + "' width='200' height='200' class='thumbnail delRow'>");
