		...
		var map;
		 map = new GMaps({
		  ...
		  map.addMarker({
			...
			lng: 80.006680,
			infoWindow: {
			  content: '<p style="color:#3b3b3b; text-align:center;"><strong>ANTICLOCK HEALTH AND FITNESS SERVICES</strong><br>NO 18 DR AMBETHKAR NAGAR (HIGH SCHOOL BACK SIDE),<br> SINGAPERUMAL KOIL, CHENNAI-603204</p>'
			}
