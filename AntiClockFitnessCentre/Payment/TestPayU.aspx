<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestPayU.aspx.cs" Inherits="AntiClockFitnessCentre.Payment.TestPayU" %>
   ...
   <input type="hidden" runat="server" id="key" name="key" />
      ...
      <table>
        ...
        <tr>
          <td>Amount: </td>
          <td>
          <asp:TextBox ID="amount" runat="server" Text="499" /></td>
          <td>First Name: </td>
          <td>
           <asp:TextBox ID="firstname" runat="server" Text="Navaneethan" /></td>
        </tr>
        <tr>
          <td>Email: </td>
          <td>
           <asp:TextBox ID="email" runat="server" Text="navanneethan@gmail.com" /></td>
          <td>Phone: </td>
          <td>
          <asp:TextBox ID="phone" runat="server" Text="9600121215" /></td>
        </tr>
        <tr>
          <td>Product Info: </td>
          <td colspan="3">
          <asp:TextBox ID="productinfo" runat="server" Text="Newly" /></td>
        </tr>
        <tr>
          <td>Success URI: </td>
          <td colspan="3">
          <asp:TextBox ID="surl" runat="server" Text="http://localhost:1345/Payment/TestPayUResponse.aspx" /></td>
        </tr>
        <tr>
          <td>Failure URI: </td>
          <td colspan="3">
          <asp:TextBox ID="furl" runat="server" Text="http://localhost:1345/Payment/TestPayUResponse.aspx" /></td>
        </tr>
        <tr>
